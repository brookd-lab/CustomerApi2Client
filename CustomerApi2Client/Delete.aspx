<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Delete.aspx.cs" Inherits="CustomerApi2Client.Delete" %>
...
<asp:Button ID="btnSearch" runat="server" Text="Search" OnClick="DisplayGrid"/></div>
        ...
        <asp:Button ID="btnUpdate" runat="server" Text="Delete" OnClick="DeleteFromTable"/>
        </div>
